...
/*
 * 扩展function from()
 * 新增参数boolean 判断是否为sql语句，如果是的话 对sql语句中的，不做处理
 */
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * @param	boolean	do not handle the first param with ,
	 * @return	object
	 */
	public function from($from, $isSql=false)
	{
		foreach ((array) $from as $val)
		{
			if (strpos($val, ',') !== FALSE && $isSql==false)
			{
