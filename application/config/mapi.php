...
$config['partner'] = $env_config['partner'];

$config['seller_id'] = $env_config['seller_id'];

//安全码
$config['safe_key'] = $env_config['safe_key'];

//编码格式只支持GBK。
$config['charset'] = "GBK";

//支付宝网关
$config['gatewayUrl'] = "https://mapi.alipay.com/gateway.do";
...
//支付异步提醒
$config['notify_url'] = $config['mapi_box_host'] . "/index.php/api/order/notify";
...
$config['open_door_succ_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，关门后系统将会自动扣款！',
...
$config['box_trouble_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，盒子发生故障，请稍后再试，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '设备故障，请稍后重试',
    'keyword3' => '',
...
$config['box_init_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，盒子正在初始化，请稍后再试，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['permission_error_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技，当前配送员无上下货操作权限，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '您没有权限开门上下货',
    'keyword3' => '',
...
$config['box_busy_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，盒子忙碌中，请稍后再试，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['no_pay_msg'] = array(
    ...
    'action' => '点击支付',
    'first' => '感谢您使用大狼科技购买商品，您有未支付的订单，请先支付，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['user_black_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，您已被限制购买，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['pay_succ_msg'] = array(
    ...
    'action' => '点击查看订单',
    'first' => '感谢您使用大狼科技购买商品，系统自动扣款成功！订单号：',
    'remark' => '魔盒期待着与您再次邂逅',
    'keyword1' => "￥",
    'keyword2' => '',
    'keyword3' => '',
...
$config['pay_fail_msg'] = array(
    ...
    'action' => '点击开通免密支付',
    'first' => '感谢您使用大狼科技，购买商品前需开通支付宝免密支付，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['pay_blance_not_enough_msg'] = array(
    ...
    'action' => '已更改支付设置，点击支付',
    'first' => '感谢您使用大狼科技购买商品，您的账号余额不足，请更改支付设置--扣款顺序，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '',
    'keyword3' => '',
...
$config['product_amount_limit_error_msg'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击手动支付',
    'first' => '感谢您使用大狼科技购买商品，您的购买的金额已超过免密支付的额度，请点击支付，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['wechat_rule_limit'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击手动支付',
    'first' => '感谢您使用大狼科技购买商品，交易金额或次数超出限制，请点击支付，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['pay_fail_unkonw_msg'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击手动支付',
    'first' => '感谢您使用大狼科技，订单支付失败，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '',
    'keyword3' => '',
...
$config['pay_inprocess'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击查看订单',
    'first' => '感谢您使用大狼科技购买商品，您的订单下单成功支付处理中，回复短信确认支付，也点击查看订单手动支付，如有疑问请在首页联系我们，谢谢！',
    'remark' => '感谢您的使用，祝您购物愉快',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '',
    'keyword3' => '',
...
$config['refund_succ_msg'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击查看订单',
    'first' => '感谢您使用大狼科技购买商品，您的申请退款已审核通过。退款金额将会原路返回，若为银行卡支付，受银行结算系统限制，通常需要3-5个工作日到账。',
...
$config['refund_against_msg'] = array(
    'url' => $config['mapi_box_host'].'/public/order.mars?orderId=',
    'action' => '点击查看订单',
    'first' => '感谢您使用大狼科技购买商品，您的申请退款已审核已被驳回。',
    'remark' => '如有疑问请在首页联系我们，谢谢！',
    'keyword1' => '用户申请退款',
    'keyword2' => '',
    'keyword3' => '',
...
$config['over_time_door_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，超时未打开门，售货机已自动关门。',
    'remark' => '如有疑问请在首页联系我们，谢谢！',
    'keyword1' => date("Y-m-d H:i:s"),
...
$config['gat_refund_error_msg'] = array(
    'url' => '',
    'action' => '',
    'first' => '感谢您使用大狼科技购买商品，您申请的退款没有成功，如有疑问请在首页联系我们，谢谢！',
    'remark' => '如有疑问请在首页联系我们，谢谢！',
    'keyword1' => date("Y-m-d H:i:s"),
    'keyword2' => '退款失败',
    'keyword3' => '',
...
$config['mobile_black_list'] = array(
    '17612158322',
    '17621079522',
    '17717360003',
    '18621009216',
...
//测试的机器，不发送告警消息
$config['test_devices'] = $env_config['test_devices'];
