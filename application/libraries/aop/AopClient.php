...
class AopClient {
	...
	/*
		...
		auther:笙默
	*/
	public function pageExecute($request,$httpmethod = "POST",$appInfoAuthtoken = NULL) {
		...
		write_log('request'.var_export($totalParams,1));
		//待签名字符串
	...
	public function execute($request, $authToken = null, $appInfoAuthtoken = null) {
        ...
        write_log("sysParams=>".var_export($sysParams,1),'debug');
		//系统参数放入GET请求串
        ...
        write_log("apiParams=>".$requestUrl.",".var_export($apiParams,1),'debug');
		//发起HTTP请求
		try {
